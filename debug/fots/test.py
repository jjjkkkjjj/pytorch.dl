...
if __name__ == '__main__':
    ...
    model.load_weights('../../weights/fots-res50/fots-icdar2013+15_model_e-500.pth')
    print(model)

    #image = cv2.cvtColor(cv2.imread('../../scripts/fots/assets/test.jpg'), cv2.COLOR_BGR2RGB)
    image = cv2.cvtColor(cv2.imread('../../scripts/fots/assets/download.jpeg'), cv2.COLOR_BGR2RGB)
