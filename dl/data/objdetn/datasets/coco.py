...
from .base import ObjectDetectionDatasetBase, Compose, ObjectDetectionDatasetMixin
...
class COCODetectionDatasetMixin(ObjectDetectionDatasetMixin, COCODatasetMixin):
...
class COCOSingleDatasetBase(COCODetectionDatasetMixin, ObjectDetectionDatasetBase):
