...
# for more information on COCO, including for the image text_data, object annotatins
...
#  COCO_Text  - COCO-Text api class that loads COCO annotations and prepare text_data structures.
