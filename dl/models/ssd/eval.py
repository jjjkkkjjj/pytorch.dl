...
from ...train.eval import EvaluatorBase
from ..._utils import _check_ins
from .core.boxes import centroids2corners_numpy, iou_numpy
...
def calc_PR(targets_loc, targets_label, infers_loc, infers_label, infers_conf, iou_threshold, class_nums):
    ...
    for t_locs, t_labels, i_locs, i_labels, i_confs in zip(targets_loc, targets_label, infers_loc, infers_label,
                                                           infers_conf):
